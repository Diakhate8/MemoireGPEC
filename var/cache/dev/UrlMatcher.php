...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/addcontrat' => [[['_route' => 'contrat.add', '_controller' => 'App\\Controller\\ContratController::addClient'], null, ['POST' => 0], null, false, false, null]],
        '/api/role' => [[['_route' => 'role.show', '_controller' => 'App\\Controller\\RoleController::index'], null, ['GET' => 0], null, false, false, null]],
        ...
        '/api/users' => [[['_route' => 'user.new', '_controller' => 'App\\Controller\\UserController::addUser'], null, ['POST' => 0], null, false, false, null]],
